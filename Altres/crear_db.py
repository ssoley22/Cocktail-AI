...
RUTA_DB = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "database.db"))
...
def crear_database():
    ...
    coctels = [
        ...
        (7,  'Vodka Taronja',            "El clàssic Tornavís. Un toc de dolçor i vitamina per gaudir de la night."),
        ...
        (20, 'Ginebra Sprite',           "Una version molt més dolça i suau per als que fugen de l'amargor de la tònica."),
        ...
        (51, 'Shirley Temple',           "El primer 'mocktail' de la història. Creat a Hollywood, és bonic i de liciós."),
    ...
    # ==========================================
    # 4. INSERIR RECEPTES (Adaptat a múltiples de 30ml / Màxim 210ml)
    # ==========================================
    receptes = [
        (1, 'Refresc Cola', 150, 1), (1, 'Whisky', 60, 2),
        (2, 'Refresc Llimona', 150, 1), (2, 'Whisky', 60, 2),
        (3, 'Gasosa', 150, 1), (3, 'Whisky', 60, 2),
        (4, 'Refresc Llima-Llimona', 150, 1), (4, 'Whisky', 60, 2),
        (5, 'Suc Taronja', 150, 1), (5, 'Whisky', 60, 2),
        (6, 'Refresc Llimona', 150, 1), (6, 'Vodka', 60, 2),
        (7, 'Refresc Taronja', 150, 1), (7, 'Vodka', 60, 2),
        (8, 'Tònica', 150, 1), (8, 'Vodka', 60, 2),
        (9, 'Refresc Llima-Llimona', 150, 1), (9, 'Vodka', 60, 2),
        (10, 'Refresc Cola', 150, 1), (10, 'Vodka', 60, 2),
        (11, 'Suc Pinya', 150, 1), (11, 'Vodka', 60, 2),
        (12, 'Suc Préssec', 150, 1), (12, 'Vodka', 60, 2),
        (13, 'Refresc Cola', 150, 1), (13, 'Rom', 60, 2),
        (14, 'Refresc Llimona', 150, 1), (14, 'Rom', 60, 2),
        (15, 'Suc Taronja', 150, 1), (15, 'Rom', 60, 2),
        (16, 'Refresc Llima-Llimona', 150, 1), (16, 'Rom', 60, 2),
        (17, 'Suc Pinya', 150, 1), (17, 'Rom', 60, 2),
        (18, 'Refresc Llimona', 150, 1), (18, 'Ginebra', 60, 2),
        (19, 'Tònica', 150, 1), (19, 'Ginebra', 60, 2),
        (20, 'Refresc Llima-Llimona', 150, 1), (20, 'Ginebra', 60, 2),
        (21, 'Refresc Taronja', 150, 1), (21, 'Ginebra', 60, 2),
        (22, 'Refresc Cola', 150, 1), (22, 'Licor Herbes', 60, 2),
        (23, 'Refresc Llimona', 150, 1), (23, 'Licor Herbes', 60, 2),
        (24, 'Tònica', 150, 1), (24, 'Licor Herbes', 60, 2),
        (25, 'Suc Pinya', 150, 1), (25, 'Licor Dolç', 60, 2),
        (26, 'Refresc Cola', 150, 1), (26, 'Licor Dolç', 60, 2),
        (27, 'Suc Pinya', 150, 1), (27, 'Licor Coco', 60, 2),
        (28, 'Refresc Cola', 150, 1), (28, 'Licor Coco', 60, 2),
        (29, 'Refresc Cola', 150, 1), (29, 'Licor Ametlla', 60, 2),
        (30, 'Gasosa', 90, 1), (30, 'Refresc Taronja', 90, 2), (30, 'Aperitiu', 30, 3),
        (31, 'Tònica', 150, 1), (31, 'Aperitiu', 60, 2),
        (32, 'Gasosa', 150, 1), (32, 'Aperitiu', 60, 2),
        (33, 'Refresc Taronja', 120, 1), (33, 'Vermut', 90, 2),
        (34, 'Refresc Llimona', 150, 1), (34, 'Tequila', 60, 2),
        (35, 'Refresc Llima-Llimona', 150, 1), (35, 'Tequila', 60, 2),
        (36, 'Refresc Cola', 150, 1), (36, 'Tequila', 60, 2),
        (37, 'Suc Taronja', 120, 1), (37, 'Vodka', 60, 2), (37, 'Colorant Vermell', 30, 3),
        (38, 'Suc Taronja', 120, 1), (38, 'Tequila', 60, 2), (38, 'Colorant Vermell', 30, 3),
        (39, 'Suc Taronja', 120, 1), (39, 'Rom', 60, 2), (39, 'Colorant Vermell', 30, 3),
        (40, 'Suc Taronja', 120, 1), (40, 'Ginebra', 60, 2), (40, 'Colorant Vermell', 30, 3),
        (41, 'Colorant Vermell', 90, 1), (41, 'Refresc Llimona', 60, 2), (41, 'Vodka', 60, 3),
        (42, 'Refresc Llimona', 120, 1), (42, 'Vodka', 60, 2), (42, 'Colorant Vermell', 30, 3),
        (43, 'Suc Taronja', 90, 1), (43, 'Colorant Vermell', 90, 2), (43, 'Rom', 30, 3),
        (44, 'Suc Taronja', 150, 1), (44, 'Vodka', 60, 2),
        (45, 'Vodka', 30, 1), (45, 'Licor Ametlla', 30, 2),
        (46, 'Refresc Llima-Llimona', 120, 1), (46, 'Tequila', 60, 2), (46, 'Licor Taronja', 30, 3),
        (47, 'Tònica', 150, 1), (47, 'Aperitiu', 30, 2), (47, 'Ginebra', 30, 3),
        (48, 'Suc Taronja', 120, 1), (48, 'Refresc Llimona', 30, 2), (48, 'Colorant Vermell', 60, 3),
        (49, 'Suc Taronja', 120, 1), (49, 'Suc Pinya', 30, 2), (49, 'Suc Préssec', 30, 3), (49, 'Colorant Vermell', 30, 4),
        (50, 'Refresc Llimona', 150, 1), (50, 'Colorant Vermell', 60, 2),
        (51, 'Refresc Llima-Llimona', 150, 1), (51, 'Colorant Vermell', 30, 2),
        (52, 'Refresc Cola', 150, 1), (52, 'Colorant Vermell', 30, 2),
        (53, 'Té', 90, 1), (53, 'Refresc Llimona', 90, 2),
        (54, 'Suc Pinya', 90, 1), (54, 'Suc Préssec', 60, 2), (54, 'Refresc Llima-Llimona', 60, 3),
        (55, 'Bitter', 90, 1), (55, 'Suc Taronja', 90, 2),
        (56, 'Tònica', 150, 1), (56, 'Colorant Vermell', 60, 2),
        (57, 'Isotònic', 150, 1), (57, 'Suc Llima', 30, 2), (57, 'Colorant Vermell', 30, 3),
    ]
    conn.executemany(
